...
exports.getPaymentSuccessEmail = (req, res) => {
  try {
    ...
    if (isDevEnv()) {
      console.log("✅ DEV MODE: Using local paymentSuccessDebug.js data");
    ...
    if (!data) {
      console.warn("No payment success data found in request");
    ...
    console.error("💥 Error in getPaymentSuccessEmail:", error);
