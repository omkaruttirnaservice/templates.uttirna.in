...
exports.getHallticketLiveEmail = (req, res) => {
  try {
    ...
    if (isDevEnv()) {
      console.log("✅ DEV MODE: Using local hallticketLiveDebug.js data");
    ...
    if (!data) {
      console.warn("No hallticket live data found in request");
    ...
    console.error("💥 Error in getHallticketLiveEmail:", error);
